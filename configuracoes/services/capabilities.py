...
PERMISSION_LABELS = {
    ...
    "perm_os_ver_custos": "Visualizar custos e margem da OS",
    "perm_os_registrar_custo": "Registrar custos da OS",
    "perm_os_estornar_custo": "Estornar custos da OS",
    ...
    "perm_caixa_gerir_cartoes_corporativos": "Gerir cartões corporativos",
    "perm_caixa_importar_extrato": "Importar extratos bancários",
    "perm_caixa_conciliar_banco": "Conciliar banco",
    "perm_caixa_fechar_banco": "Fechar/reabrir banco",
    "perm_caixa_gerir_capital": "Gerir capital e sócios",
    "perm_caixa_administrar_plano_contas": "Administrar plano de contas",
    "perm_caixa_corrigir_lancamentos": "Corrigir lançamentos financeiros",
