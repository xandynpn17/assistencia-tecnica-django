...
def painel_impl(request):
    ...
    secoes = [
        {
            "titulo": "Configurações da operação",
            ...
            "itens": [
                {
                    ...
                    "descricao": "Identidade, endereço, contatos e logos institucionais.",
                    "url": "configuracoes:empresa",
                    "cta": "Configurar",
                },
                {
                    ...
                    "descricao": "Regime, alíquotas e parâmetros fiscais usados na operação.",
                    "url": "configuracoes:empresa",
                    "query": "secao=fiscal",
                    "cta": "Configurar",
                },
                {
                    "titulo": "Atendimento e OS",
                    "icone": "fas fa-tools",
                    "descricao": "Numeração, abertura, campos obrigatórios, SLA e garantia.",
                    "url": "configuracoes:configuracao_sistema",
                    "query": "secao=atendimento",
                    "cta": "Configurar",
                },
                {
                    "titulo": "Regras gerais",
                    "icone": "fas fa-cog",
                    "descricao": "Localização, busca de clientes e serviços de CEP.",
                    "url": "configuracoes:configuracao_sistema",
                    "query": "secao=geral",
                    "cta": "Configurar",
                },
            ...
            "itens": [
                {
                    ...
                    "icone": "fas fa-boxes",
                    "descricao": "Reserva, custo, inventário e políticas de movimentação.",
                    "url": "configuracoes:configuracao_sistema",
                    "query": "secao=estoque",
                    "cta": "Configurar",
                },
                {
                    ...
                    "descricao": "Comissões, desempenho e proteção de operações sensíveis.",
                    "url": "configuracoes:configuracao_sistema",
                    "query": "secao=financeiro",
                    "cta": "Configurar",
                },
                {
                    "titulo": "Comunicação",
                    "icone": "fas fa-comments",
                    "descricao": "Modelos para WhatsApp, e-mail e eventos de atendimento.",
                    "url": "configuracoes:modelos_mensagem",
                    "cta": "Configurar",
                },
                {
                    "titulo": "Documentos e impressão",
                    "icone": "fas fa-file-pdf",
                    "descricao": "OS, orçamento, relatório técnico, termos e pré-visualização.",
                    "url": "configuracoes:configuracao_sistema",
                    "query": "secao=documentos",
                    "cta": "Configurar",
                },
            ],
        },
            ...
            "itens": [
                {
                    ...
                    "descricao": "Tipos disponíveis no cadastro e na abertura das ordens.",
                    "url": "configuracoes:tipos_equipamento",
                    "cta": "Gerenciar",
                },
                {
                    ...
                    "descricao": "Marcas, parceiros, fornecedores e regras relacionadas.",
            ...
            "itens": [
                {
                    ...
                    "descricao": "Perfis, acessos e permissões para ações sensíveis.",
                    ...
                    "cta": "Gerenciar" if request.user.is_superuser or request.user.tipo_usuario == "adm" else "Novo usuário",
                },
                {
                    "titulo": "Privacidade e manutenção",
                    "icone": "fas fa-shield-alt",
                    "descricao": "LGPD, diretório oficial e retenção dos backups.",
                    "url": "configuracoes:configuracao_sistema",
                    "query": "secao=manutencao",
                    "cta": "Configurar",
                },
                {
                    "titulo": "Auditoria",
                    "icone": "fas fa-clipboard-list",
                    "descricao": "Alterações críticas, backups, restaurações e rastreabilidade.",
                    "url": "configuracoes:auditoria_configuracoes",
                    "cta": "Visualizar",
                },
            ],
        ...
        {
            "titulo": "Monitoramento e continuidade",
            ...
            "itens": [
                {
                    ...
                    "descricao": "Prazos operacionais e pendências críticas.",
                    "url": "configuracoes:regras_sla",
                    "cta": "Configurar",
                },
                {
                    "titulo": "Garantia e reincidências",
                    "icone": "fas fa-shield-alt",
                    "descricao": "Indicadores de retorno por técnico, marca e equipamento.",
                ...
                },
                {
                    ...
                    "descricao": "Cópias oficiais, recuperação local e restauração administrativa.",
                    "url": "configuracoes:backup_banco",
                    "cta": "Abrir",
                },
                {
                    "titulo": "Logs de integrações",
                    "icone": "fas fa-plug",
    ...
    return render(
        ...
        "configuracoes/painel.html",
        {
            ...
            "operacao_tab": "painel",
            "operacao_title": "Central de configurações",
            "operacao_subtitle": "Encontre regras da operação, cadastros de apoio, segurança e manutenção em áreas separadas.",
