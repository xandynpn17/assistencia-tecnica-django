...
SENSITIVE_PERMISSION_MESSAGES = {
    ...
    "perm_os_editar_observacoes_internas": "Voce nao tem permissao para editar as observacoes internas desta OS.",
    "perm_os_editar_local_armazenamento": "Voce nao tem permissao para editar o local de armazenamento desta OS.",
    "perm_os_alterar_tecnico": "Voce nao tem permissao para alterar o tecnico responsavel desta OS.",
    "perm_os_excluir_servico_peca": "Voce nao tem permissao para excluir servicos ou pecas desta OS.",
    ...
    "perm_orcamento_editar": "Voce nao tem permissao para criar ou editar este orcamento.",
    "perm_orcamento_aprovar_item": "Voce nao tem permissao para aprovar itens do orcamento.",
    "perm_orcamento_recusar_item": "Voce nao tem permissao para recusar itens do orcamento.",
    "perm_orcamento_migrar_item": "Voce nao tem permissao para migrar itens do orcamento para Servicos e Pecas.",
    ...
    "perm_caixa_cancelar_conta_receber": "Voce nao tem permissao para cancelar contas a receber.",
    "perm_caixa_editar_conta_receber": "Voce nao tem permissao para editar contas a receber.",
    ...
    "perm_caixa_editar_conta_pagar": "Voce nao tem permissao para editar contas a pagar.",
    ...
    "perm_estoque_cadastro_produto": "Voce nao tem permissao para cadastrar ou editar produtos do estoque.",
    "perm_estoque_excluir_produto": "Voce nao tem permissao para excluir produtos do estoque.",
    "perm_estoque_ajuste_manual": "Voce nao tem permissao para registrar ajustes manuais de estoque.",
    "perm_estoque_transferencia": "Voce nao tem permissao para transferir ou repor estoque entre pontos.",
